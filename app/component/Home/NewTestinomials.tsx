...
export default function Testimonials() {
	...
	return (
		<section className="py-[80px] bg-[#e1e1e1] relative ">
			<div className="w-full flex justify-start padding-x pb-[40px] pl-[10px] lg:pl-[60px]">
				<h1 className="text-[#202020] uppercase leading-none text-[50px] md:text-[100px] lg:text-[100px] font-bold overflow-hidden">
				...
				<Marquee baseVelocity={-0.2}>
					<div className="flex m-0 gap-x-[20px] items-center mr-[20px] bg-[#e1e1e1] relative z-[60]">
						{testimonials.slice(0, 4).map((item) => (
							<div
								className="flex flex-col gap-[10px] md:gap-[20px]"
								key={item.id}>
								<div className=" min-w-[250px] min-h-[160px]  md:min-w-[500px] md:min-h-[400px] py-[10px] px-[15px] md:py-[20px] md:px-[40px] border border-[#222222]/10 rounded-[10px] bg-[#d6d5d5] flex flex-col gap-[5px] md:gap-[20px] justify-between">
									<p className="text-black text-[15px] md:text-[30px] font-medium leading-tight tracking-wide">
										{item.text}
									</p>
									<div className="flex items-center gap-[10px]  md:gap-[20px]">
										<Image
											...
											height={50}
											unoptimized 
											className="rounded-full h-[30px] w-[30px] md:h-[60px] md:w-[60px]"
										/>
										<div className="flex flex-col">
											<h1 className="text-black text-[9px] md:text-[18px] font-medium leading-tight">
												{item.name}
											</h1>
											<p className="text-black text-[8px] md:text-[16px] font-normal leading-tight">
												{item.username}
											</p>
										</div>
									</div>
					...
					<div className="flex m-0 gap-x-[20px] items-center mr-[20px] bg-[#e1e1e1] relative z-[60]">
						{testimonials.slice(5).map((item) => (
							<div
								...
								key={item.id}>
								<div className="min-w-[250px] min-h-[160px]  md:min-w-[500px] md:min-h-[400px] py-[10px] px-[15px] md:py-[20px] md:px-[40px] border border-[#222222]/10 rounded-[10px] bg-[#d6d5d5] flex flex-col gap-[20px] justify-between">
									<p className="text-black text-[15px] md:text-[30px] font-medium leading-tight tracking-wide">
										{item.text}
									</p>
