...
<div className="flex flex-row justify-end ">
  ...
  <div className="text-center w-20 md:w-80 h-px bg-gray-800  opacity-35 mt-3"></div>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-0 mr-4 md:mr-0 lg:gap-4 mt-16">
            ...
            <div className="flex items-center justify-center space-x-6 w-full">
             <h1 className="text-3xl md:text-7xl "><span className={`${outfit.className} font-semibold`}>together. Ready </span> <span className={`${outfit.className} font-extralight`}>when you are.</span></h1> 
